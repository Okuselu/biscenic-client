...
const carouselImages3 = [
  "/images/crystal-vase-grey-base.png",
  "/images/crystal-vase-wood-base.jpeg",
]
...
function Carousel({ images, autoSlide = true, height = "70vh" }: CarouselProps) {
  ...
  return (
    ...
    >
      ...
      {/* Navigation Buttons */}
      <button
        className={`absolute left-4 top-1/2 -translate-y-1/2 z-20 p-3 bg-white bg-opacity-30 rounded-full text-black hover:bg-opacity-50 transition-opacity duration-300 ${
      ...
      <button
        className={`absolute right-4 top-1/2 -translate-y-1/2 z-20 p-3 bg-white bg-opacity-30 rounded-full text-black hover:bg-opacity-50 transition-opacity duration-300 ${
          isHovered ? "opacity-100" : "opacity-0"
        }`}
        onClick={nextSlide}
...
export default function Exhibition() {
  return (
    <div className="min-h-screen bg-black">
      ...
      {/* Carousels */}
      <Carousel images={carouselImages1} autoSlide height="70vh" />
      <Carousel images={carouselImages2} autoSlide height="70vh" />
      <Carousel images={carouselImages3} autoSlide height="70vh" />
