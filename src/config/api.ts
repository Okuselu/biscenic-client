...
export const API_ENDPOINTS = {
  ...
  reviews: {
    byProduct: (productId: string) =>
      `${API_BASE_URL}/api/reviews/products/${productId}/reviews`,
  ...
  users: {
    ...
    ordersbyUserId: (userId: string) => `${API_BASE_URL}/api/order/user/${userId}`
  },
  ...
  orders: {
    ...
    updateById: (id: string) => `${API_BASE_URL}/api/orders/${id}`,
  },
...
// Force redeployment - Sun Aug 31 22:54:42 WAT 2025
