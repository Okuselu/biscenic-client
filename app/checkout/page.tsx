...
//   const totalInKobo = Math.round(total * 100) // Paystack
...
//     if (cart.length === 0) {
//       toast({ title: "Empty Cart", description: "Your cart is empty. Add items before checkout.", variant: "destructive" })
//       return
//     }
...
//     try {
//       await initializePaymentMutation.mutateAsync({ email: shippingInfo.email, amount: totalInKobo })
//     } catch (error) {
...
//   if (!isPaymentReturn && cart.length === 0) {
//     return (
//       <div className="min-h-screen flex items-center justify-center bg-gray-50">
//         <div className="text-center">
...
//                   <Input id="firstName" value={shippingInfo.firstName} onChange={(e) => handleInputChange("firstName", e.target.value)} required className="mt-1" />
//                 </div>
//                 <div>
//                   <Label htmlFor="lastName">Last Name *</Label>
//                   <Input id="lastName" value={shippingInfo.lastName} onChange={(e) => handleInputChange("lastName", e.target.value)} required className="mt-1" />
//                 </div>
//               </div>
//               <div>
//                 <Label htmlFor="email">Email Address *</Label>
//                 <Input id="email" type="email" value={shippingInfo.email} onChange={(e) => handleInputChange("email", e.target.value)} required className="mt-1" />
//               </div>
//               <div>
//                 <Label htmlFor="phone">Phone Number *</Label>
//                 <Input id="phone" type="tel" value={shippingInfo.phone} onChange={(e) => handleInputChange("phone", e.target.value)} required placeholder="+234..." className="mt-1" />
//               </div>
//             </CardContent>
//           </Card>
...
//                   </div>
//                   <div className="text-right font-medium">{typeof item.price === "string" ? parseFloat(item.price).toLocaleString() : item.price.toLocaleString()}</div>
//                 </div>
//               ))}
