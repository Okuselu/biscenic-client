...
export default function OrderConfirmationPage() {
  ...
  useEffect(() => {
    const timer = setTimeout(redirectToHome, REDIRECT_DELAY)
        ...
        <Card className="text-center">
          ...
          <CardContent className="space-y-4" aria-live="polite">
            ...
            <div className="bg-green-50 p-4 rounded-lg">
              <p className="text-sm text-green-700 font-semibold">Order Confirmed</p>
            ...
            <p className="text-xs text-gray-500 mt-4">
              Redirecting to homepage in {REDIRECT_DELAY / 1000} seconds...
            </p>
          </CardContent>
        </Card>
      </div>
