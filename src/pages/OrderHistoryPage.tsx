...
const OrderHistoryPage: React.FC = () => {
  ...
  return (
    <div className="container py-5">
      <h2 className="mb-4" style={{ color: 'var(--text-primary)' }}>Order History</h2>
                  ...
                  <div className="card-body" style={{ padding: '1.25rem' }}>
                    <div className="row">
                        ...
                        {order.orderItems && order.orderItems.length > 0 ? (
                          order.orderItems.map((item) => (
                            <div
                              ...
                              style={{ 
                                padding: '0.5rem 0',
                                borderBottom: `1px solid ${cardStyle.textColor === 'white' ? 'rgba(255,255,255,0.2)' : 'rgba(0,0,0,0.1)'}`,
                                fontSize: '0.85rem'
                              }}
                            >
                          ...
                          <p style={{ 
                            color: cardStyle.textColor === 'white' ? 'rgba(255,255,255,0.7)' : 'var(--text-muted)',
                            fontSize: '0.85rem'
                          }}>
                            No items found
                          </p>
                      ...
                      <div className="col-md-4 text-md-end">
                        ...
                        <p className="mb-3">
                          <small style={{ 
                            color: cardStyle.textColor === 'white' ? 'rgba(255,255,255,0.8)' : 'var(--text-secondary)',
                            fontSize: '0.8rem'
                          }}>
                            Ordered on:{" "}
                        ...
                        <Link
                          ...
                          style={{
                            backgroundColor: cardStyle.textColor === 'white' ? 'rgba(255,255,255,0.2)' : 'var(--primary-color)',
                            color: cardStyle.textColor === 'white' ? 'white' : 'white',
                            border: `1px solid ${cardStyle.textColor === 'white' ? 'rgba(255,255,255,0.3)' : 'var(--primary-color)'}`,
                            borderRadius: '6px',
                            padding: '0.4rem 1rem',
                            fontSize: '0.8rem',
                            fontWeight: '500',
          ...
          <ul className="pagination justify-content-center" style={{ gap: '0.5rem' }}>
            <li className={`page-item ${currentPage === 1 ? "disabled" : ""}`}>
              <button
                ...
                style={{
                  backgroundColor: currentPage === 1 ? 'var(--surface-color)' : 'var(--primary-color)',
                  color: currentPage === 1 ? 'var(--text-muted)' : 'white',
                  borderRadius: '8px',
                  padding: '0.6rem 1rem',
                  fontSize: '0.85rem',
                  fontWeight: '500',
                  border: `1px solid ${currentPage === 1 ? 'var(--border-color)' : 'var(--primary-color)'}`,
                  transition: 'all 0.2s ease',
                ...
                onMouseEnter={(e) => {
                  if (currentPage !== 1) {
                    ...
                    e.currentTarget.style.transform = 'translateY(-1px)';
                    e.currentTarget.style.boxShadow = '0 4px 8px rgba(126, 143, 108, 0.3)';
                  }
                }}
                onMouseLeave={(e) => {
                  if (currentPage !== 1) {
            ...
            {[...Array(totalPages)].map((_, index) => (
              ...
              >
                <button
                  ...
                  style={{
                    backgroundColor: currentPage === index + 1 ? 'var(--accent-color)' : 'var(--surface-color)',
                    color: currentPage === index + 1 ? 'white' : 'var(--text-primary)',
                    borderRadius: '8px',
                    padding: '0.6rem 0.8rem',
                    fontSize: '0.85rem',
                    fontWeight: currentPage === index + 1 ? '600' : '500',
                    border: `1px solid ${currentPage === index + 1 ? 'var(--accent-color)' : 'var(--border-color)'}`,
                    transition: 'all 0.2s ease',
                    minWidth: '40px',
                    cursor: 'pointer'
                  }}
            ...
            >
              <button
                ...
                style={{
                  backgroundColor: currentPage === totalPages ? 'var(--surface-color)' : 'var(--primary-color)',
                  color: currentPage === totalPages ? 'var(--text-muted)' : 'white',
                  borderRadius: '8px',
                  padding: '0.6rem 1rem',
                  fontSize: '0.85rem',
                  fontWeight: '500',
                  border: `1px solid ${currentPage === totalPages ? 'var(--border-color)' : 'var(--primary-color)'}`,
                  transition: 'all 0.2s ease',
